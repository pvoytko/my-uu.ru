...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.zpayment_type_code'
        db.add_column(u'my_uu_payment', 'zpayment_type_code',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.zpayment_type_code'
        db.delete_column(u'my_uu_payment', 'zpayment_type_code')
