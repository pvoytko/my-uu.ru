...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.visible'
        db.add_column(u'my_uu_account', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Account.balance_start'
        db.add_column(u'my_uu_account', 'balance_start',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=11, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.visible'
        db.delete_column(u'my_uu_account', 'visible')

        # Deleting field 'Account.balance_start'
        db.delete_column(u'my_uu_account', 'balance_start')
    ...
    models = {
        ...
        u'my_uu.account': {
            ...
            'balance_start': ('django.db.models.fields.DecimalField', [], {'max_digits': '11', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
