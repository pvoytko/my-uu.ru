...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'my_uu_event')

        # Deleting field 'EventLog.event'
        db.delete_column(u'my_uu_eventlog', 'event_id')


    def backwards(self, orm):
        # Adding model 'Event'
        db.create_table(u'my_uu_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
        ))
        db.send_create_signal(u'my_uu', ['Event'])


        # User chose to not deal with backwards NULL issues for 'EventLog.event'
        raise RuntimeError("Cannot reverse this migration. 'EventLog.event' and its values cannot be restored.")
