...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventLog.date'
        db.alter_column(u'my_uu_eventlog', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'EventLog.date'
        db.alter_column(u'my_uu_eventlog', 'date', self.gf('django.db.models.fields.DateField')())
