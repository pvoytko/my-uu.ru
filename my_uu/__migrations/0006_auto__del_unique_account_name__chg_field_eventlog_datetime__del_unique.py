...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventLog.datetime'
        db.alter_column(u'my_uu_eventlog', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EventLog.datetime'
        db.alter_column(u'my_uu_eventlog', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
