...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ManualSteps.datetime_canceled'
        db.delete_column(u'my_uu_manualsteps', 'datetime_canceled')

        # Adding field 'ManualSteps.datetime_cancel'
        db.add_column(u'my_uu_manualsteps', 'datetime_cancel',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ManualSteps.datetime_canceled'
        db.add_column(u'my_uu_manualsteps', 'datetime_canceled',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'ManualSteps.datetime_cancel'
        db.delete_column(u'my_uu_manualsteps', 'datetime_cancel')
    ...
    models = {
        ...
        u'my_uu.manualsteps': {
            ...
            'datetime_cancel': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
