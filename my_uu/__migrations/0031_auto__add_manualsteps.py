...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ManualSteps'
        db.create_table(u'my_uu_manualsteps', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('datetime_subscribe', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('datetime_canceled', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'my_uu', ['ManualSteps'])


    def backwards(self, orm):
        # Deleting model 'ManualSteps'
        db.delete_table(u'my_uu_manualsteps')
