...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.view_period'
        db.delete_column(u'my_uu_userprofile', 'view_period')

        # Adding field 'UserProfile.view_period_code'
        db.add_column(u'my_uu_userprofile', 'view_period_code',
                      self.gf('django.db.models.fields.CharField')(default='last3', max_length=10),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.view_period'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.view_period' and its values cannot be restored.")
        # Deleting field 'UserProfile.view_period_code'
        db.delete_column(u'my_uu_userprofile', 'view_period_code')
    ...
    models = {
        ...
        u'my_uu.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
            'view_period_code': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
        u'my_uu.utype': {
