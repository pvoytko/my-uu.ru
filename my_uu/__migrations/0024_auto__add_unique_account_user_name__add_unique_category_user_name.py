...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Account', fields ['user', 'name']
        db.create_unique(u'my_uu_account', ['user_id', 'name'])

        # Adding unique constraint on 'Category', fields ['user', 'name']
        db.create_unique(u'my_uu_category', ['user_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['user', 'name']
        db.delete_unique(u'my_uu_category', ['user_id', 'name'])

        # Removing unique constraint on 'Account', fields ['user', 'name']
        db.delete_unique(u'my_uu_account', ['user_id', 'name'])
