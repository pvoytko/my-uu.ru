...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.days'
        db.add_column(u'my_uu_payment', 'days',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=30),
                      keep_default=False)

        # Adding field 'Payment.date_from'
        db.add_column(u'my_uu_payment', 'date_from',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Payment.date_to'
        db.add_column(u'my_uu_payment', 'date_to',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.days'
        db.delete_column(u'my_uu_payment', 'days')

        # Deleting field 'Payment.date_from'
        db.delete_column(u'my_uu_payment', 'date_from')

        # Deleting field 'Payment.date_to'
        db.delete_column(u'my_uu_payment', 'date_to')
